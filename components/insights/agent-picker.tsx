    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger
        render={
          <button
            type="button"
            className={cn(
              "flex h-8 items-center gap-1.5 rounded-md border border-border bg-[#333333]/30 px-2.5 text-xs text-foreground transition-colors hover:bg-secondary/80",
              className,
            )}
          >
      ...
      >
        <div className="flex flex-col">
          ...
          <div className="flex items-center justify-between border-t border-white/[0.04] p-2">
            <button
              type="button"
              disabled={!agentId}
              onClick={() => {
