                  ...
                  <div className="space-y-5">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 border-b border-border px-3 py-2">
                        ...
                        <span className="ml-2 text-xs uppercase tracking-wider text-muted-foreground font-medium">
                          · expected format
                        </span>
                        <button
                          type="button"
                      ...
                      >
                        ...
                        <div className="flex-1 h-6 rounded border border-border bg-card px-2 flex items-center text-xs font-mono text-foreground">
                          phone
                        </div>
                      </div>
                    ...
                    <div className="flex items-center gap-3 rounded-xl border border-border bg-card px-3 py-2.5">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="inline-flex shrink-0 items-center gap-1 rounded-md bg-primary px-2 py-0.5 text-xs font-medium text-primary-foreground">
