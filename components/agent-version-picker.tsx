    ...
    >
      ...
      <PopoverTrigger
        render={
          <button
            type="button"
            className="flex h-8 w-full items-center gap-2.5 rounded-lg border border-border bg-transparent dark:bg-secondary px-3 text-left text-sm text-foreground outline-none transition-colors focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
          />
        }
      >
        {agent ? (
      ...
      <PopoverContent
        ...
        sideOffset={6}
        style={SURFACE_BG}
        className={cn(CARD, "p-0 w-[720px] max-w-[94vw] overflow-hidden border-border")}
      >
