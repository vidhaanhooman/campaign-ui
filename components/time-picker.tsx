      ...
      <PopoverTrigger
        render={
          <button
            type="button"
            className={cn(
              "flex h-[52px] items-center gap-3 rounded-md border border-border bg-[#333333]/30 px-3 text-left transition-colors hover:border-muted-foreground/40 focus:border-white outline-none",
              className,
            )}
          />
        }
