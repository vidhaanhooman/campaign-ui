      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-12">
        ...
        <Section title="Typography & radii">
          <div className="flex flex-col gap-2">
            <div className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Band label</div>
        ...
        <Section title="Transition label — forward chip vs backward jump chip">
          <div className="flex flex-wrap items-center gap-6">
            <button className="inline-flex max-w-[160px] items-center gap-1.5 rounded-md border border-border bg-card px-2 py-0.5 text-xs text-foreground shadow-sm">
              <span className="truncate">If true</span>
              <Pencil size={9} className="shrink-0 text-muted-foreground" />
            </button>
            <span className="inline-flex items-center gap-1 rounded-full border border-violet-500/50 bg-violet-500/[0.14] px-2 py-0.5 text-xs font-medium text-violet-200">
        ...
        <Section title="Transition detail — hover popover">
          <div className="w-max min-w-[160px] max-w-[260px] rounded-lg border border-border bg-popover px-3 py-2 shadow-xl">
            ...
            <div className="text-xs leading-relaxed text-foreground">caller intent is booking</div>
            <div className="mt-1.5 inline-flex items-center gap-1 rounded border border-border px-1.5 py-0.5 text-xs text-muted-foreground">
              <Zap size={9} className="text-amber-400" /> check_calendar
            </div>
            <div className="mt-1.5 border-t border-border pt-1.5 text-xs text-muted-foreground/70">
            ...
            {[
              ...
              <button key={label} className="flex w-full items-center gap-2.5 rounded-lg px-2 py-1.5 text-left transition-colors hover:bg-secondary/60">
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="block truncate text-xs text-muted-foreground/70">{desc}</span>
                </span>
              </button>
            ))}
          </div>
        ...
        <Section title="Canvas controls — tidy up · loop toggle · add branch">
          <div className="flex flex-wrap items-center gap-3">
            <button className="inline-flex items-center gap-2 rounded-lg border border-border bg-card/90 px-2.5 py-1.5 text-xs font-medium text-muted-foreground shadow-lg transition-colors hover:text-foreground">
              <Network size={13} /> Tidy up
            </button>
            <button className="inline-flex items-center gap-2 rounded-lg border border-border bg-card/90 px-2.5 py-1.5 text-xs font-medium text-muted-foreground shadow-lg transition-colors hover:text-foreground">
              <CornerDownRight size={13} className="rotate-180" /> Show loops
              <span className="rounded bg-white/[0.06] px-1 text-xs">3</span>
            </button>
            <button className="inline-flex items-center gap-2 rounded-lg border border-violet-500/50 bg-violet-500/[0.14] px-2.5 py-1.5 text-xs font-medium text-violet-200 shadow-lg">
              <CornerDownRight size={13} className="rotate-180" /> Hide loops
              <span className="rounded bg-violet-500/25 px-1 text-xs">3</span>
            </button>
            <button className="inline-flex h-6 items-center gap-1 rounded-full border border-border bg-card px-2 text-xs font-medium text-muted-foreground transition-colors hover:border-foreground/40 hover:text-foreground">
              <Plus size={11} /> Branch
            </button>
          </div>
        </Section>
  ...
  return (
    <div className="flex items-center gap-2.5">
      ...
      <div className="min-w-0">
        ...
        <div className="truncate font-mono text-xs text-muted-foreground">{v}</div>
      </div>
    </div>
  );
}
