      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-8 px-8 py-8">
        ...
        {near.length > 0 && (
          <div className="flex items-start gap-3 rounded-lg border border-border px-4 py-3">
            ...
            <button className="shrink-0 text-xs font-medium text-foreground transition-opacity hover:opacity-80">
              Upgrade
            </button>
          </div>
        )}
    ...
    <div>
      <div className="flex items-center justify-between gap-4">
        ...
        <span className="shrink-0 font-mono text-sm tabular-nums">
          <span className={nearLimit ? "text-foreground" : "text-foreground"}>
            {compact(used)}
            {suffix}
          </span>
      ...
      <div className="mt-2 flex items-center justify-between text-xs">
        ...
        {nearLimit && (
          <button className="inline-flex items-center gap-0.5 font-medium text-foreground transition-opacity hover:opacity-80">
