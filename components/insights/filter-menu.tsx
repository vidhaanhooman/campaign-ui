...
export function FilterPanel({
  ...
  return (
    <div className="flex h-full min-h-0 w-[300px] shrink-0 flex-col overflow-hidden rounded-lg border border-border bg-popover">
      <div className="border-b border-border p-2">
        <div className="flex items-center gap-2">
          <div className="flex h-8 flex-1 items-center gap-2 rounded-md border border-input bg-transparent px-2.5 dark:bg-secondary">
  ...
  return (
    <Popover open={open} onOpenChange={change}>
      ...
      >
        ...
        {/* Search */}
        <div className="border-b border-border p-2">
          <div className="flex h-8 items-center gap-2 rounded-md border border-input bg-transparent px-2.5 dark:bg-secondary">
            <Search size={13} className="shrink-0 text-muted-foreground" />
            <input
              value={query}
              onChange={(e) => setQuery(e.target.value)}
