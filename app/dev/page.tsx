...
export default function DevPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "var(--background)" }}>
      {/* top bar */}
      <header className="flex items-center gap-4 border-b border-white/[0.04] px-6 py-3" style={{ backgroundColor: "var(--card)" }}>
        <Link
          href="/campaigns"
      ...
      {/* step jumper */}
      {view !== "components" && (
        <div className="flex items-center gap-2 border-b border-white/[0.04] px-6 py-2.5" style={{ backgroundColor: "var(--card)" }}>
      ...
      <main className="flex-1 p-6 overflow-auto">
        {view === "realtime" && (
          <div
            className="mx-auto border border-border rounded-xl overflow-hidden shadow-xl shadow-black/40"
    ...
    <div className="mx-auto max-w-4xl space-y-8">
      ...
      <Section title="Number Stepper">
        <div className="flex items-center gap-4">
          <div>
            <div className="text-xs text-muted-foreground mb-2">No suffix</div>
            <NumberStepper value={num} onChange={setNum} className="w-32" />
          </div>
          <div>
            <div className="text-xs text-muted-foreground mb-2">With % suffix</div>
            <NumberStepper
              value={pct}
              onChange={setPct}
              suffix="%"
      ...
      <Section title="Buttons">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            disabled
            className="rounded-md bg-primary px-4 py-1.5 text-xs font-medium text-primary-foreground opacity-50 cursor-not-allowed"
          >
            Disabled
          </button>
        </div>
  ...
  return (
    <div className="rounded-md border border-border overflow-hidden">
      <div
        ...
        style={{
          backgroundColor: textFor ? "var(--card)" : value,
