  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-col min-h-0 flex-1">
          ...
          <div className="px-8 py-6 max-w-3xl w-full mx-auto">
                ...
                {!abOn ? (
                  <div className="space-y-2">
                    ...
                    <div className="text-xs text-muted-foreground leading-relaxed">
                      <span className="font-medium text-foreground">Live</span> always
                    ...
                    {abArms.map((arm, i) => (
                      <div key={i} className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md text-muted-foreground hover:bg-secondary hover:text-foreground disabled:cursor-not-allowed disabled:text-muted-foreground/50 disabled:hover:bg-transparent"
                        >
                          <X size={13} />
                        </button>
                      </div>
                    ...
                    <div className="flex items-center justify-between pt-1">
                      ...
                      <span
                        className={cn(
                          ...
                          abTotal === 100 ? "text-muted-foreground" : "text-foreground",
                        )}
                      >
                        {abTotal}% assigned
                        {abTotal !== 100 && (
                ...
                {!uploaded ? (
                  <div className="space-y-5">
                    ...
                    >
                      ...
                      {/* Fake menu bar */}
                      <div className="flex items-center gap-4 border-b border-white/[0.06] px-3 py-1 text-xs text-muted-foreground">
                        <span>File</span>
                        <span>Edit</span>
                        <span>View</span>
                        <span>Insert</span>
                      ...
                      {/* Formula bar */}
                      <div
                        className="flex items-center gap-3 border-b border-white/[0.06] px-2 py-1.5"
                      ...
                      <div className="font-mono text-xs text-foreground">
                        {/* Column letters */}
                        <div
                          className="grid grid-cols-[32px_1.4fr_1fr_1fr] border-b border-white/[0.06] text-xs text-muted-foreground"
                          style={{ backgroundColor: "var(--background)" }}
                        >
                          <div className="border-r border-white/[0.06] px-2 py-1 text-center">
                            &nbsp;
                          </div>
                          <div className="border-r border-white/[0.06] px-2 py-1 text-center">
                            A
                        ...
                        {/* Schema header row 1 */}
                        <div className="grid grid-cols-[32px_1.4fr_1fr_1fr] border-b border-white/[0.06]">
                          <div
                            className="border-r border-white/[0.06] px-2 py-1.5 text-center text-xs text-muted-foreground"
                            style={{ backgroundColor: "var(--background)" }}
                          >
                            1
                          </div>
                          <div className="border-r border-white/[0.06] px-3 py-1.5 font-medium text-emerald-400">
                            phone
                          </div>
                          <div className="border-r border-white/[0.06] px-3 py-1.5 font-medium text-blue-400">
                            name
                          </div>
                        ...
                        {SAMPLE_ROWS.slice(0, 3).map((r, i) => (
                          <div
                            key={i}
                            className="grid grid-cols-[32px_1.4fr_1fr_1fr] border-b border-white/[0.06] last:border-b-0"
                          >
                            <div
                              className="border-r border-white/[0.06] px-2 py-1.5 text-center text-xs text-muted-foreground"
                              style={{ backgroundColor: "var(--background)" }}
                            ...
                            <div className="border-r border-white/[0.06] px-3 py-1.5">
                              {r.phone}
                            </div>
                            <div className="border-r border-white/[0.06] px-3 py-1.5">
                              {r.name}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="rounded-md border border-border bg-[#333333]/30 overflow-hidden">
                      <div className="grid grid-cols-[1.4fr_1fr_1fr] border-b border-white/[0.06] bg-[#333333]/30 px-3 py-2 text-xs font-medium text-muted-foreground">
            ...
            {step === 3 && (
              <div className="space-y-6">
                ...
                <FieldGroup label="Campaign expiry">
                  <DatePickerTime
                ...
                <FieldGroup label="Calling hours">
                  ...
                  rows={[
                    [
                      ...
                      uploaded ? (
                        ...
                        <span className="italic text-muted-foreground">No CSV uploaded</span>
                      ),
                    ],
                    [
                      "Rows",
                  ...
                  rows={[
                    ...
                    [
                      ...
                      <span
                        key="b"
                        className={
                          bursting ? "text-foreground" : "text-muted-foreground"
                        }
                      >
                        {bursting ? "On" : "Off"}
                      </span>,
        ...
        {/* footer */}
        <div
          className="flex items-center justify-between border-t border-white/[0.06] px-8 py-3"
        >
          <button
    ...
    <div>
      ...
      <div className="overflow-hidden rounded-xl border border-border bg-[#333333]/30">
        {visible.map(([label, value], i) => (
          ...
          >
            <div className="border-r border-white/[0.06] bg-[#333333]/30 px-3 py-2.5 text-muted-foreground">
              {label}
            </div>
  ...
  return (
    <div className="rounded-xl border border-border bg-[#333333]/30 overflow-hidden">
      ...
      <div className="p-4 space-y-3">
        ...
        <Row label="Audience">
          {!uploaded ? (
            <span className="text-muted-foreground italic">No CSV uploaded</span>
          ) : (
            <>
        ...
        <Row label="Calling hours">
          ...
          <span className="text-muted-foreground ml-1.5">{tz}</span>
        </Row>
        ...
        <Row label="Retry when">
          {outcomes.length === 0 ? (
            <span className="text-muted-foreground italic">No outcomes</span>
          ) : (
