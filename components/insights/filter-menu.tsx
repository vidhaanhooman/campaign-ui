...
export function FilterPanel({
  ...
  return (
    <div className="flex h-full min-h-0 w-[300px] shrink-0 flex-col overflow-hidden rounded-xl border border-sidebar-border/15 bg-popover">
      <div className="border-b border-sidebar-border/30 p-2">
        <div className="flex items-center gap-2">
          <div className="flex h-8 flex-1 items-center gap-2 rounded-md border border-sidebar-border/30 bg-transparent px-2.5 dark:bg-secondary">
...
function FilterFieldRow({
  ...
  return (
    <Popover open={open} onOpenChange={change}>
      ...
      >
        {/* Header — field name */}
        <div className="flex items-center gap-2 border-b border-sidebar-border/30 px-3 py-2.5">
        ...
        {/* Footer — Clear + Apply */}
        <div className="flex items-center justify-between gap-2 border-t border-sidebar-border/30 p-2">
          <Button
            type="button"
            variant="ghost"
            size="sm"
